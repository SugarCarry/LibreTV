// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["heimuer", "ffzy", "dyttzy", "tyyszy", "ckzy", "zy360", "wolong", "cjhw", "hwba", "jisu", "dbzy", "bfzy", "mozhua", "mdzy", "ruyi", "jkun", "bwzy", "souav", "r155", "lsb", "huangcang", "zuid", "yutu","yinghua","biadu","wujin"]'); // 默认选中黑木耳和豆瓣资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 仅选择天涯资源、暴风资源和如意资源
        selectedAPIs = ["heimuer", "ffzy", "dyttzy", "tyyszy", "ckzy", "zy360", "wolong", "cjhw", "hwba", "jisu", "dbzy", "bfzy", "mozhua", "mdzy", "ruyi", "jkun", "bwzy", "souav", "r155", "lsb", "huangcang", "zuid", "yutu","yinghua","biadu","wujin"];
